...
import { ProviderProfilesTab } from "./provider-profiles-tab";
import { useT } from "../../i18n";

const ACCOUNT_TAB_KEYS = ["profile", "preferences", "notifications", "tokens", "provider-profiles"] as const;
const ACCOUNT_TAB_ICONS = {
  profile: User,
  preferences: SlidersHorizontal,
  notifications: Bell,
  tokens: Key,
  "provider-profiles": Cpu,
} as const;
    ...
    >
      ...
      <div className="flex-1 min-w-0 md:overflow-y-auto">
        <div className="w-full max-w-3xl mx-auto p-4 md:p-6">
          ...
          <TabsContent value="provider-profiles"><ProviderProfilesTab /></TabsContent>
